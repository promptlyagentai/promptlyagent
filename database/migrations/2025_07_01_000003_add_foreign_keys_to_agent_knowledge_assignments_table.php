...
return new class extends Migration
{
    ...
    {
        Schema::table('agent_knowledge_assignments', function (Blueprint $table) {
    ...
    {
        Schema::table('agent_knowledge_assignments', function (Blueprint $table) {
            $table->dropForeign('agent_knowledge_assignments_agent_id_foreign');
            $table->dropForeign('agent_knowledge_assignments_knowledge_document_id_foreign');
            $table->dropForeign('agent_knowledge_assignments_knowledge_tag_id_foreign');
        });
    }
};
