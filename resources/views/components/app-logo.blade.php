{{--
    App Logo Component (Full)

    Purpose: Complete PromptlyAgent logo with text and icon

    Features:
    - Full "PROMPTLYAGENT" text
    - Geometric icon with brackets
    ...
    Logo Components:
    - Text: White fill
    - Center P: Accent color with stroke
    - Brackets: Primary color palette with gradient
    - Dark mode: Adjusted bracket colors

    Color Variables:
    - --color-accent: Center P fill
    - --palette-primary-*: Bracket gradients
    - Automatic fallbacks for each color
    ...
    Dark Mode:
    - .dark class triggers different bracket colors
    - Lighter primary shades for visibility
    - Defined in embedded style tag
    ...
    Related:
    - components.app-logo-icon: Icon-only version
    - Used in layouts/auth and layouts/app
--}}
<div class="flex items-center justify-center w-full px-4 py-3">
    <svg viewBox="0 0 1290.8 618.64" class="h-16 w-auto max-w-full" xmlns="http://www.w3.org/2000/svg">
        <style>
